...
pub(super) use cursorpeek_core::sniff::is_text_eligible_path as is_eligible_path;
#[cfg(test)]
use cursorpeek_core::sniff::{TEXT_EXTENSIONS, TEXT_NAMES};
use cursorpeek_core::sniff::{TextByteKind, classify_text_prefix as classify_prefix};
