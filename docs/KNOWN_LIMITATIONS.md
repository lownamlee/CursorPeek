...
- CursorPeek requires one unambiguous local filesystem item from the active Explorer view. Folders,
  virtual Shell items, and ambiguous or changing candidates do not preview.
