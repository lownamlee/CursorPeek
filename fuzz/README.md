...
```sh
cargo fuzz run protocol -- -max_len=8388632 -timeout=5 -rss_limit_mb=768
cargo fuzz run payload -- -max_len=8388608 -timeout=5 -rss_limit_mb=768
...
cargo fuzz run svg_render -- -max_len=65536 -timeout=5 -rss_limit_mb=768
```
